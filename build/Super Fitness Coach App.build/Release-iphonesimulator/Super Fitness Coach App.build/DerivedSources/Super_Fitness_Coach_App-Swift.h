...
#ifndef SUPER_FITNESS_COACH_APP_SWIFT_H
#define SUPER_FITNESS_COACH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Super_Fitness_Coach_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class WCSession;
@class NSString;
SWIFT_CLASS("_TtC23Super_Fitness_Coach_App16WCSessionManager")
